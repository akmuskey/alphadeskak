...
export default function LoadingScreen({ onComplete }: { onComplete: () => void }) {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      ctx.fillStyle = 'hsla(155, 100%, 50%, 0.35)';
  ...
  return (
    <div className="fixed inset-0 z-50 bg-background flex items-center justify-center">
      ...
      <div className="relative z-10 text-center">
        <h1 className="font-mono text-2xl tracking-[0.4em] text-primary mb-8 font-bold">
          A L P H A D E S K
        </h1>
        ...
        <div className="mt-6 w-64 h-px bg-border mx-auto overflow-hidden">
          <div
